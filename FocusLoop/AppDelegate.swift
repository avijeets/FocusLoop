...
class AppDelegate: UIResponder, UIApplicationDelegate, WCSessionDelegate {
    ...
    func session(_ session: WCSession, didReceiveUserInfo userInfo: [String : Any] = [:]) {
        // Distraction object creation -> Core Data submission
        let distraction = Distractions(context: persistentContainer.viewContext)
        
        guard let date = userInfo["date"] as? Data, let name = userInfo["name"] as? String else {
            return
        }
        
        distraction.name = name
